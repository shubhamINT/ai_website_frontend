/**
 * /partners — placeholder Partners page (local test target for VAANI navigation).
 * Client-side routing keeps the widget's chat session alive.
 */
